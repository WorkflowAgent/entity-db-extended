...
```js
const manualItems = [
  { myVectorField: [0.1,0.2,...], metadata: { name: 'A' } },
  { myVectorField: [0.3,0.4,...], metadata: { name: 'B' } },
];
...
const manualItemsWithId = [
  { id: 10, myVectorField: [0.1,0.2,...], metadata: { name: 'A' } },
  { id: 20, myVectorField: [0.3,0.4,...], metadata: { name: 'B' } },
];
